...
public class PIN extends AppCompatActivity {
    ...
    public void login(View V11) {
        String passo = sh.putdata();
    ...
    public void forgot(View v12) {
        AlertDialog.Builder builder = new AlertDialog.Builder(PIN.this);
        View v = getLayoutInflater().inflate(R.layout.alerrt_for_saving_pin_recovery, null);
        ...
        sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String ans = sh.verify();
                if (supername.equals("")) {
                    Toast.makeText(PIN.this, "Please give the answer", Toast.LENGTH_SHORT).show();
                }
                if (supername.equals(ans)) {
                    sh.remov();
                    Intent j = new Intent(getApplicationContext(), state_checker.class);
                    startActivity(j);
                    finish();
                }
            }
