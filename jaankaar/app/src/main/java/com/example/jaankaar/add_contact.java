...
public class add_contact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1 = (EditText) findViewById(R.id.ac_name);
        t2 = (EditText) findViewById(R.id.ac_phone);
        t3 = (EditText) findViewById(R.id.ac_email);
        img = (de.hdodenhof.circleimageview.CircleImageView) findViewById(R.id.ac_image);
       // progressBar = (ProgressBar)findViewById(R.id.pb2);
        login_state_checker = new login_state_checker(this);
        save = (Button) findViewById(R.id.ad_con);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    if(result)
                    {
                        Toast.makeText(getApplicationContext(), "Please wait till the file is been loaded", Toast.LENGTH_LONG).show();
